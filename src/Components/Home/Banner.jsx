    ...
    >
      ...
      <div className="hero-content text-center text-neutral-content">
        <div className="max-w-md">
          ...
          <form><input className="p-2 text-black rounded-l-lg  w-56" type="text" placeholder="Search here...."/>
          <input className="bg-red-600 rounded-r-lg p-2 pl-2 pr-3 text-base font-semibold" type="submit" value=' Search'/></form>
        </div>
      </div>
    </div>
  );
